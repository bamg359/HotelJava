...
public class Service {
    ...
    public Service(int idService, String nameService, double price, String state) {
    ...
    public List<Service> getAll(List<Service> serviceList) {
        return serviceList;
    }

    public void getById(int id, Service service) {
    ...
    public void update(Service productoEditado) {
    }
