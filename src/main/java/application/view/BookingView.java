...
public class BookingView {
    ...
    public BookingView(int bookingId, String fecha, int cantidad, BedRoom bedRoom, Guest guest, Service service) {
    ...
    public BookingView create(BookingView booking) {
    ...
    public List<BookingView> getAll(List<BookingView> bookingList) {
        return bookingList;
    }

    public void getById(int id, BookingView booking) {
    ...
    public void update(BookingView productoEditado) {
    }
